package org.lyflexi.bootrocketmq_producer;
...
import org.lyflexi.bootrocketmq_producer.domain.MsgModel;
...
//        rocketMQTemplate.syncSend("bootTagTopic:tagA", "我是一个带tag的消息");
    ...
    void jyTest() throws Exception {
        for (int i = 1001; i <= 2000; i++) {
            rocketMQTemplate.syncSend("jyTest", "我是第" + i + "个消息");
        }
    }
    /*跳过积压*/
    @Test
    void jumpTopic() throws Exception {
        for (int i = 1001; i <= 2000; i++) {
